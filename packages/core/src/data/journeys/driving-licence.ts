 ...
 * counter working hours for any RTO, the Gujarat transport department grievance
 * URLs (the menu labels are printed but the links are generated by JavaScript
 * and absent from the served HTML), an iOS bundle id for mParivahan, and RTO
 * addresses for the thirty Gujarat districts outside Ahmedabad, Surat and
 * Vadodara. Those render as "not verified yet" rather than as a plausible
 * guess, which is why the generic office:rto node is still here.
 */
...
export const sources: Source[] = [
  ...
  {
    id: "src:parivahan-contact",
    url: "https://parivahan.gov.in/en/content/contact-us",
    title: "Contact Us | Parivahan Sewa",
    domain: "parivahan.gov.in",
    sourceType: "HELPLINE",
    retrievedAt: RETRIEVED,
  },
  {
    id: "src:gj-dl",
    url: "https://cot.gujarat.gov.in/driving-licence.htm",
    title: "Driving License | Commissionerate of Transport, Government of Gujarat",
    domain: "cot.gujarat.gov.in",
    sourceType: "SERVICE_PAGE",
  ...
  {
    id: "src:gj-rto",
    url: "https://cot.gujarat.gov.in/rto-arto.htm",
    title: "RTO/ARTO | Commissionerate of Transport, Government of Gujarat",
    domain: "cot.gujarat.gov.in",
  ...
  {
    id: "src:gj-helpline",
    url: "https://cot.gujarat.gov.in/helpline-number.htm",
    title: "Helpline Number | Commissionerate of Transport, Government of Gujarat",
    domain: "cot.gujarat.gov.in",
    sourceType: "HELPLINE",
    jurisdictionId: "IN-GJ",
    retrievedAt: RETRIEVED,
  ...
  {
    id: "src:mparivahan-play",
    url: "https://play.google.com/store/apps/details?id=com.nic.mparivahan",
    title: "NextGen mParivahan, Apps on Google Play (National Informatics Centre)",
    domain: "play.google.com",
    sourceType: "MOBILE_APP_INFO",
    retrievedAt: RETRIEVED,
  },
  {
    id: "src:digilocker-app",
    url: "https://www.digilocker.gov.in/web/installapp",
    title: "Download DigiLocker Mobile App",
...
export const nodes: GraphNode[] = [
  ...
  // The rest of the Form 2 ANNEXURE list. Numbered exactly as the annexure
  // numbers them, so the quote on each one can be checked against the PDF.
  {
    id: "document:aadhaar",
    type: "DOCUMENT",
    name: "Aadhaar card",
  ...
  {
    id: "document:electoral_roll",
    type: "DOCUMENT",
    name: "Electoral roll entry",
    aliases: ["voter id", "voter card", "electoral roll"],
    jurisdictionId: "IN",
    metadata: { selfProvided: true },
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence: "2. Electoral Roll",
        confidence: 0.97,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "document:life_insurance_policy",
    type: "DOCUMENT",
    name: "Life insurance policy",
    aliases: ["lic policy", "insurance policy"],
    jurisdictionId: "IN",
    metadata: { selfProvided: true },
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence: "3. Life Insurance Policy",
        confidence: 0.97,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "document:school_certificate",
    type: "DOCUMENT",
    name: "School certificate",
    aliases: ["school leaving certificate", "lc", "transfer certificate"],
    jurisdictionId: "IN",
    metadata: { selfProvided: true },
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence: "5. School Certificate",
        confidence: 0.97,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "document:government_pay_slip",
    type: "DOCUMENT",
    name: "Government pay slip",
    officialName: "Pay slip issued by any office of the State Government or Central Government or a local Body",
    description: "Only counts if the office that issued it is a State, Central or local body office.",
    jurisdictionId: "IN",
    metadata: { selfProvided: true },
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence: "7. Pay slip issued by any office of the State Government or Central Government or a local Body",
        confidence: 0.97,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "document:sworn_affidavit",
    type: "DOCUMENT",
    name: "Sworn affidavit",
    officialName:
      "Affidavit sworn before an Executive Magistrate or Notary Public or First Class Judicial Magistrate",
    description:
      "The fallback when you hold none of the other nine. Someone else has to swear it in, so allow time for it.",
    jurisdictionId: "IN",
    sources: [
      {
        sourceId: "src:cmvr-form-2",
  ...
  {
    id: "document:civil_surgeon_age_certificate",
    type: "DOCUMENT",
    name: "Age certificate from a Civil Surgeon",
    officialName:
    ...
    description: "Proves age only. A doctor below the rank of Civil Surgeon is not accepted.",
    jurisdictionId: "IN",
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence:
          "9. A certificate granted by a Registered Medical Practitioner not below the rank of Civil Surgeon as to the age of the applicant",
        confidence: 0.97,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "document:state_specified_proof",
    type: "DOCUMENT",
    name: "Any other document the State Government specifies",
    description:
      "The annexure leaves the list open for each state to extend. Gujarat publishes its own age and address lists, which is where the two sources part company.",
    jurisdictionId: "IN",
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence: "10. Any other document or documents as may be specified by State Government",
        confidence: 0.97,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "document:passport_photo",
    type: "DOCUMENT",
    name: "Passport size photograph",
    description: "Uploaded with the online application. The upload is capped at 50 KB.",
    jurisdictionId: "IN",
    metadata: { selfProvided: true },
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence:
          "Space for passport size photograph (Upload the photo for online application of the size not more than 50 KB)",
        confidence: 0.95,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "document:guardian_declaration",
    type: "DOCUMENT",
    name: "Parent or guardian declaration",
    officialName: "Declaration under sub-section (2) of section 7 of the Motor Vehicles Act, 1988",
    description:
      "Signed by the person who has care of a minor applicant, accepting responsibility for their driving. It is printed on Form 2 itself.",
    jurisdictionId: "IN",
    metadata: {
      selfProvided: true,
      whatToDo:
        "Have the parent or guardian fill and sign the declaration section of Form 2 giving consent for the learner's licence.",
      formNumber: "Form 2",
    },
    sources: [
      {
  ...
  // -- actions -------------------------------------------------------------
  {
    ...
    metadata: {
      ...
      whatToDo:
        "Carry four printed things: the acknowledgement that lists your required documents, the application form with Form 1 and Form 1A, the appointment letter, and the fee receipt. Take the original documents too, not just the uploads.",
  ...
  {
    id: "action:learner_licence_test",
    type: "ACTION",
    name: "Pass the learner's licence test",
    officialName: "STALL Test",
    description:
      "A computer test on traffic rules and signs. It is an online test, but you sit it at the RTO, not at home.",
    jurisdictionId: "IN",
    metadata: {
      whyRequired: "You do not get a learner's licence without passing it.",
      whatToDo:
        "Report to the RTO you applied to, or to its authorised learning licence test centre, on your appointment date.",
      expectedOutput: "A pass, after which the learner's licence is issued.",
      fee: "Rs. 50.00 test fee or repeat test fee",
    },
    sources: [
      {
        sourceId: "src:parivahan-faq",
        evidence:
          "Yes, you have to pass the online test (STALL Test) to get Learner's License. After the completion of its one\n\nmonth you need to appear for driving test to get your driving license.",
        confidence: 0.92,
        verificationStatus: "VERIFIED",
      },
      {
        sourceId: "src:parivahan-faq",
        evidence: "You need to report the concerned RTO or their authorized learning license test center.",
        confidence: 0.93,
        verificationStatus: "VERIFIED",
      },
      {
  ...
  // -- payments ------------------------------------------------------------
  {
    ...
    description:
      "Sources conflict on the amount. The central Parivahan schedule says Rs. 150 for the licence plus Rs. 50 test fee. The Gujarat transport department page still quotes Rs. 25 test fee plus Rs. 30 per class of vehicle. Take the higher figure with you and ask at the counter.",
    jurisdictionId: "IN",
    metadata: {
      fee: "Rs. 150.00 to issue the licence in Form 3, plus Rs. 50.00 test fee",
      whatToDo:
    ...
    sources: [
      ...
      {
        // Not averaged, not picked. Both figures are printed by a government
        // page today and only the counter can settle it.
        sourceId: "src:gj-dl",
        evidence:
          "The fee for Learning License and Driving License has to be paid together.Rs.25/-as test fee plus Rs.30/- per category of vehicle is required to be paid for Learning License.\nRs.200/- for a Smart Card Driving License and Rs.50/- per category of vehicle is required to be paid for Driving License.",
        confidence: 0.75,
  ...
  },
  {
    ...
    description:
      "Sources conflict on the amount. The central Parivahan schedule says Rs. 300 for the test plus Rs. 200 to issue the licence. The Gujarat transport department page quotes Rs. 200 for a smart card licence plus Rs. 50 per class of vehicle and does not mention a test fee at all. Take the higher figure with you and ask at the counter.",
    jurisdictionId: "IN",
    metadata: {
  ...
  },
  {
    ...
    description:
      "You choose the RTO during the online application, and that is the one you visit. This is the fallback for the districts whose address we have not verified off the Gujarat RTO directory yet.",
    jurisdictionId: "IN",
  ...
  // The three Gujarat RTOs whose full row we could read off the official
  // RTO/ARTO directory. The directory prints the STD code in its own column,
  // so the numbers below are the STD code and the number dialled together.
  // It publishes no counter hours for any office, so workingHours stays unset.
  {
    id: "office:rto_ahmedabad",
    type: "OFFICE",
    name: "RTO Ahmedabad (GJ01)",
    officialName: "RTO Ahmedabad",
    description: "Fax 079-27559696.",
    jurisdictionId: "IN-GJ-AHMEDABAD",
    metadata: {
      officeType: "Regional Transport Office",
      address: "RTO Office, Subhash Bridge, Sabarmati, Ahmedabad - 380027.",
      phoneNumbers: ["079-27559697"],
      emails: ["rto-trans-ahd@gujarat.gov.in"],
    },
    sources: [
      {
        sourceId: "src:gj-rto",
        evidence:
          "1|\nRTO |\nAhmedabad|\nGJ01|\nRTO Office, Subhash Bridge, Sabarmati,Ahmedabad- 380027.|\nEmail: rto-trans-ahd@gujarat.gov.in|\n079|\n27559697|\n27559696|",
        confidence: 0.93,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  },
  {
    ...
    type: "OFFICE",
    name: "RTO Surat (GJ05)",
    officialName: "RTO Surat",
    description: "Fax 0261-2464253.",
    jurisdictionId: "IN-GJ-SURAT",
    metadata: {
      officeType: "Regional Transport Office",
      address: "RTO Office, Ring Road, Nanpura, Surat - 385001.",
      phoneNumbers: ["0261-2464902"],
      emails: ["rto-trans-sur@gujarat.gov.in"],
    },
    sources: [
      {
        sourceId: "src:gj-rto",
        evidence:
          "5|\nRTO Surat|\nGJ05|\nRTO Office, Ring Road, Nanpura, Surat - 385001.|\nEmail: rto-trans-sur@gujarat.gov.in|\n0261|\n2464902|\n2464253|",
        confidence: 0.93,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "office:rto_vadodara",
    type: "OFFICE",
    name: "RTO Vadodara (GJ06)",
    // The directory table spells it "Vadodra" and the site navigation spells
    // it "Vadodara". Both are the same office.
    officialName: "RTO Vadodra",
    aliases: ["rto vadodra", "rto baroda"],
    description: "Fax 0265-2562497.",
    jurisdictionId: "IN-GJ-VADODARA",
    metadata: {
      officeType: "Regional Transport Office",
      address: "RTO Office, Near Golden Chokdi NH 8, Darji Pura, Vadodra - 390006.",
      phoneNumbers: ["0265-2561130"],
      emails: ["rto-trans-vad@gujarat.gov.in"],
    },
    sources: [
      {
        sourceId: "src:gj-rto",
        evidence:
          "6|\nRTO |\nVadodra|\nGJ06|\nRTO Office, Near Golden Chokdi NH 8, Darji Pura, Vadodra - 390006.|\nEmail: rto-trans-vad@gujarat.gov.in|\n0265|\n2561130|\n2562497|",
        confidence: 0.93,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  // -- helplines and apps --------------------------------------------------
  {
    id: "helpline:sarathi",
    type: "HELPLINE",
    name: "Sarathi helpline",
    description: "The national helpdesk for learner's licence and driving licence problems.",
    jurisdictionId: "IN",
    metadata: {
      channelType: "PHONE",
      phoneNumbers: ["+91-120-2459169"],
      emails: ["helpdesk-sarathi@gov.in"],
      workingHours: "06:00AM - 10:00PM",
    },
    sources: [
      {
        sourceId: "src:parivahan-faq",
        evidence:
          "You can call us on our Helpline number: +91-120-2459169 (Timings: 06:00AM - 10:00PM)\n\nEmail: helpdesk-sarathi@gov.in(link sends e-mail)",
        confidence: 0.92,
        verificationStatus: "VERIFIED",
      },
      {
        sourceId: "src:parivahan-contact",
        evidence: "| Learner License, Driving Licence etc | helpdesk-sarathi\\[at\\]gov\\[dot\\]in |",
        confidence: 0.95,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "helpline:gujarat_dl_printing",
    type: "HELPLINE",
    name: "Gujarat driving licence printing and dispatch helpline",
    description:
      "The Gujarat transport department line for one specific problem: the licence has been granted but the card has not been printed or posted.",
    jurisdictionId: "IN-GJ",
    metadata: {
      channelType: "PHONE",
      phoneNumbers: ["079-29914473", "079-29914474"],
    },
    sources: [
      {
        sourceId: "src:gj-helpline",
        evidence: "Helpline Number \n1) Driving License Printing and dispatch related queries\n079 -29914473|\n079- 29914474",
        confidence: 0.93,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  },
  {
    ...
    type: "MOBILE_APP",
    name: "mParivahan",
    officialName: "NextGen mParivahan",
    aliases: ["mparivahan", "nextgen mparivahan"],
    description:
      "The Ministry of Road Transport and Highways app. Carries a virtual driving licence with a QR code, and finds RTO offices.",
    jurisdictionId: "IN",
    metadata: {
      // No iOS bundle id. The research could not verify one, so there is none
      // here. A guessed store id sends people to the wrong app.
      androidAppId: "com.nic.mparivahan",
      url: "https://play.google.com/store/apps/details?id=com.nic.mparivahan",
    },
    sources: [
      {
        sourceId: "src:mparivahan-play",
        evidence:
          "# NextGen mParivahan\n\n[National Informatics Centre.](https://play.google.com/store/apps/dev?id=9076108670215860604)",
        confidence: 0.93,
        verificationStatus: "VERIFIED",
      },
      {
  ...
  },
  {
    ...
    type: "MOBILE_APP",
    name: "DigiLocker",
    aliases: ["digilocker", "digi locker"],
    description: "Holds the issued driving licence as a document you can show instead of the card.",
    jurisdictionId: "IN",
    metadata: {
      androidAppId: "com.digilocker.android",
      iosAppId: "1320618078",
      url: "https://www.digilocker.gov.in/web/installapp",
    },
    sources: [
      {
        sourceId: "src:digilocker-app",
        evidence:
          "[![](https://cdn.digilocker.gov.in//assets/img/playstore_2.png)](https://play.google.com/store/apps/details?id=com.digilocker.android)\n\n[![](https://cdn.digilocker.gov.in//assets/img/ios_1.png)](https://itunes.apple.com/in/app/digilocker/id1320618078)",
        confidence: 0.93,
        verificationStatus: "VERIFIED",
      },
    ],
...
export const requirementGroups: RequirementGroup[] = [
  {
    ...
    jurisdictionId: "IN",
    members: [
      { nodeId: "document:aadhaar", note: "Covers both address and age." },
      { nodeId: "document:electoral_roll", note: "Covers both address and age." },
      { nodeId: "document:life_insurance_policy", note: "Covers both address and age." },
      { nodeId: "document:passport", note: "Covers both address and age." },
      { nodeId: "document:school_certificate", note: "Covers both address and age." },
      { nodeId: "document:birth_certificate", note: "Proves age." },
      { nodeId: "document:government_pay_slip", note: "Covers both address and age." },
      { nodeId: "document:sworn_affidavit", note: "Accepted when you hold none of the others." },
      { nodeId: "document:civil_surgeon_age_certificate", note: "Proves age." },
      {
        nodeId: "document:state_specified_proof",
        note: "In Gujarat this is where the light bill, telephone bill, house tax receipt, PAN card and voter I-card come in.",
      },
    ],
    sources: [
      {
...
/** The three RTO directory rows, quoted once for the visit edges below. */
const VERIFIED_RTOS = [
  {
    officeId: "office:rto_ahmedabad",
    jurisdictionId: "IN-GJ-AHMEDABAD",
    slug: "ahmedabad",
    district: "Ahmedabad",
    evidence:
...
/**
 * Anywhere the generic office:rto is wired from, the three districts we have a
 * real address for get their own edge alongside it. No page says in as many
 * words "an Ahmedabad applicant goes to the Ahmedabad RTO": the directory says
 * which office serves Ahmedabad and Sarathi says you go to the concerned RTO,
 * and putting those two together is ours. So NORMALIZED, not VERIFIED.
 */
const rtoVisitEdges = (fromId: string, slug: string): GraphEdge[] =>
  VERIFIED_RTOS.map((rto) => ({
    id: `e:${slug}_visit_rto_${rto.slug}`,
    from: fromId,
    to: rto.officeId,
    type: "VISIT_AT",
    jurisdictionId: rto.jurisdictionId,
    note: `In ${rto.district} district, this is the office you go to.`,
    verificationStatus: "NORMALIZED",
    sources: [
      { sourceId: "src:gj-rto", evidence: rto.evidence, confidence: 0.9, verificationStatus: "NORMALIZED" },
    ],
  }));
...
export const edges: GraphEdge[] = [
  // -- learner's licence ---------------------------------------------------
  {
    // Both sources agree proof is required. They disagree about the shape of
    // the requirement: Form 2 models it as one proof covering both age and
    // address, Gujarat publishes two separate lists. Kept as one group with the
    // disagreement stated, because building three groups would be us deciding.
    id: "e:ll_requires_proof",
    from: "service:learner_licence",
    to: "document_group:address_and_age_proof",
    type: "REQUIRES",
    jurisdictionId: "IN",
    note: "Gujarat's transport department publishes two separate lists, one for age and one for address, where the central Form 2 asks for a single proof. If the document you pick only proves one of the two, carry a second one that proves the other.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:cmvr-form-2",
      ...
      },
      {
        sourceId: "src:gj-dl",
        evidence:
          "School Leaving Certificate, Passport, L.I.C. Policy, Electoral Voter I-Card, Light Bill, Telephone Bill, receipt of House Tax with address, Pay Slip of Central/State/Local self Government or an Affidavit from the applicant to that effect can be submitted asthe proof for address.",
        confidence: 0.95,
        verificationStatus: "CONFLICTING",
      },
    ],
  ...
  {
    id: "e:ll_requires_photo",
    from: "service:learner_licence",
    to: "document:passport_photo",
    type: "REQUIRES",
    jurisdictionId: "IN",
    note: "Keep the file under 50 KB or the upload is rejected.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:cmvr-form-2",
  ...
  {
    id: "e:ll_requires_guardian_declaration",
    from: "service:learner_licence",
    to: "document:guardian_declaration",
    type: "REQUIRES",
    condition: { field: "age", operator: "LT", value: 18 },
    jurisdictionId: "IN",
    note: "A minor applicant needs a parent or guardian to sign the declaration on Form 2 accepting responsibility.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:cmvr-form-2",
        evidence:
          "Parent or Guardian Declaration in case of applicant who is a minor",
        confidence: 0.96,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    // Four official pages disagree about when Form 1A is needed, and no page
    // reconciles them. All of them are kept. Picking one silently is exactly
    // the thing this product exists to stop doing.
    id: "e:ll_requires_form_1a_always",
    from: "service:learner_licence",
    to: "document:form_1a_medical",
    type: "REQUIRES",
    jurisdictionId: "IN",
    note: "Four official pages disagree about when Form 1A is needed. The Parivahan FAQ says from age 40, the Sarathi learner licence FAQ says it is always attached to Form 1, the Form 2 annexure says only for a renewal above 40 or for a transport licence, and the Gujarat transport department says it is required with every application. Nobody is harmed by carrying it, so carry it.",
    verificationStatus: "CONFLICTING",
    sources: [
      {
        sourceId: "src:sarathi-ll-faq",
      ...
      },
      {
        sourceId: "src:cmvr-form-2",
        evidence:
          "Medical Certificate in Form-1A (to be provided if the applicant is applying for renewal and is above 40 years of age or applying for Transport Licence)",
        confidence: 0.96,
        verificationStatus: "CONFLICTING",
      },
    ],
  ...
  {
    // The third position, and the one an RTO counter in Gujarat is most likely
    // to take. Scoped to Gujarat because that is the page it comes from.
    id: "e:ll_requires_form_1a_gujarat",
    from: "service:learner_licence",
    to: "document:form_1a_medical",
    type: "REQUIRES",
    jurisdictionId: "IN-GJ",
    note: "Sources conflict. The Gujarat transport department says the medical certificate in Form 1A is attached to every learning and driving licence application, with no age condition, while the national pages tie it to age 40 and above. In Gujarat, take it with you.",
    verificationStatus: "CONFLICTING",
    sources: [
      {
        sourceId: "src:gj-dl",
        evidence:
          "An applicant is required to apply in Form No.2/4 for the purpose of both learning as well as driving license, Medical Certificate in Form No.1 (A) is also required to be attached.",
        confidence: 0.9,
        verificationStatus: "CONFLICTING",
      },
    ],
  ...
  ...rtoVisitEdges("action:visit_rto_verification", "rto_visit"),
  {
    id: "e:ll_requires_test",
    from: "service:learner_licence",
    to: "action:learner_licence_test",
    type: "REQUIRES",
    jurisdictionId: "IN",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:parivahan-faq",
        evidence: "Yes, you have to pass the online test (STALL Test) to get Learner's License.",
        confidence: 0.92,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "e:ll_test_after_fee",
    from: "action:learner_licence_test",
    to: "payment:learner_licence_fee",
    type: "DEPENDS_ON",
    jurisdictionId: "IN",
    note: "The test fee is part of the same payment, and you are asked for the fee slip on the day.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:parivahan-faq",
        evidence: "6. Visit RTO on scheduled date with original documents & Fee Slip",
        confidence: 0.94,
        verificationStatus: "VERIFIED",
      },
    ],
  ...
  {
    id: "e:ll_test_visit_at_office",
    from: "action:learner_licence_test",
    to: "office:rto",
    type: "VISIT_AT",
    jurisdictionId: "IN",
    note: "The test is online but you cannot sit it from home.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:parivahan-faq",
  ...
  ...rtoVisitEdges("action:learner_licence_test", "ll_test"),
  {
    id: "e:ll_call_sarathi_helpline",
    from: "service:learner_licence",
    to: "helpline:sarathi",
    type: "CALL_IF",
    jurisdictionId: "IN",
    note: "Call when the application is stuck and the portal will not say why.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:parivahan-faq",
  ...
  {
    id: "e:ll_available_via_mparivahan",
    from: "service:learner_licence",
    to: "app:mparivahan",
    type: "AVAILABLE_VIA",
    jurisdictionId: "IN",
    note: "The app also shows RTO office locations, which is useful before the first visit.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:sarathi-home",
  ...
  ...rtoVisitEdges("action:driving_test", "test"),
  {
    id: "e:dl_call_sarathi_helpline",
    from: "service:driving_licence",
    to: "helpline:sarathi",
    type: "CALL_IF",
    jurisdictionId: "IN",
  ...
  {
    id: "e:dl_call_gujarat_printing_helpline",
    from: "service:driving_licence",
    to: "helpline:gujarat_dl_printing",
    type: "CALL_IF",
    jurisdictionId: "IN-GJ",
    note: "Call this one if you passed the test but the licence card has not reached you by post.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:gj-helpline",
  ...
  {
    id: "e:dl_available_via_mparivahan",
    from: "service:driving_licence",
    to: "app:mparivahan",
    type: "AVAILABLE_VIA",
    jurisdictionId: "IN",
    note: "Carries a virtual driving licence with a QR code, so you are not dependent on the card arriving.",
    verificationStatus: "VERIFIED",
    sources: [
      {
        sourceId: "src:sarathi-home",
  ...
  {
    // The quote assumes the licence shows up in DigiLocker and tells you what
    // to do when it does not. That it is available there at all is our reading
    // of the sentence rather than the sentence itself, so NORMALIZED.
    id: "e:dl_available_via_digilocker",
    from: "service:driving_licence",
    to: "app:digilocker",
    type: "AVAILABLE_VIA",
    jurisdictionId: "IN",
    note: "Your RTO has to migrate the licence details to the Sarathi portal before they appear here. If the licence is missing, that migration is what to ask your RTO about.",
    verificationStatus: "NORMALIZED",
    sources: [
      {
        sourceId: "src:parivahan-faq",
        evidence:
          "Driving License details are needed to be migrated from RTO to Sarathi portal by your concerned RTO. If the Driving License details are not found in Digilocker, please consult your RTO/Department",
        confidence: 0.9,
        verificationStatus: "NORMALIZED",
      },
    ],
